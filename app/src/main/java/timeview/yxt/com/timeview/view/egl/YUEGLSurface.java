...
public abstract class YUEGLSurface extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public YUEGLSurface(Context context) {
        this(context, null);
    }

    public YUEGLSurface(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YUEGLSurface(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public YUEGLSurface(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        this.setRender();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        mYUGLThread = new YUGLThread(new WeakReference<YUEGLSurface>(this));
    ...
    static class YUGLThread extends Thread {
        private WeakReference<YUEGLSurface> yuEglSurfaceViewWeakReference = null;
        ...
        public YUGLThread(WeakReference<YUEGLSurface> yuEglSurfaceViewWeakReference) {
