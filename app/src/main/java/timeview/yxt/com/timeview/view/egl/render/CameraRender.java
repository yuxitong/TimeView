package timeview.yxt.com.timeview.view.egl.render;
...
import timeview.yxt.com.timeview.view.egl.BitmapRender;
import timeview.yxt.com.timeview.view.egl.ShaderUtils;
import timeview.yxt.com.timeview.view.egl.YUEGLSurface;

public class CameraRender implements YUEGLSurface.YuGLRender, SurfaceTexture.OnFrameAvailableListener {
    ...
    private BitmapRender cameraFboRender;
    ...
    public CameraRender(Context context, int width, int height) {
        ...
        restMatrix();
        cameraFboRender = new BitmapRender(context);
        cameraFboRender.setWidthAndHeight(width,height);
